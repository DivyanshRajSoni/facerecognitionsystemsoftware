...
class Face_Recognition:
    def __init__(self, root):
        ...
        img_top = Image.open(r"F:/face_recognition_project-main/college_images/fir.png")
        ...
        img_bottom = Image.open(r"F:/face_recognition_project-main/college_images/faceq.jpg")
        ...
        b1_1 = Button(f_lbl, text="FACE RECOGNITION", command=self.face_recog, cursor="hand2",font=("times new roman", 13, "bold"), bg="green", fg="white")
